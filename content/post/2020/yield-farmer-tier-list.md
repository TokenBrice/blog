...
This post can be a living document. Feel free to suggest incentivised pools I've missed. If you are familiar with Github, **[you can do a pull request](https://github.com/TokenBrice/blog/blob/master/content/post/2020/yield-farmer-tier-list.md)**. If not, just reach out and share documentation about the pool and its incentive program.
...
[^6]: The Curve sUSD pool was already mentioned as part of a DeFi investment strategy built on an SNX stake in the [DeFinancial Service Guide](https://tokenbrice.xyz/definancial-guide/#5-a-the-synthetixcurve-yieldstack-aka-the-4-steaks-yieldburger)
