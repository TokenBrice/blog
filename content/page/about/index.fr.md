...
- **Respectueux de la vie privée** : aucun tracker intrusif, seulement une analyse simple auto-hébergée avec Matomo. [En savoir plus](https://tokenbrice.xyz/hello-world/)
- **Transparent** : ce blog vit dans un [dépôt GitHub](https://github.com/tokenbrice/blog/), vous pouvez suivre et tracker toutes les modifications.
